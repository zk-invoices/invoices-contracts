import { Field, Mina, PrivateKey, AccountUpdate, MerkleTree, UInt32, Bool } from 'o1js';
...
describe.skip('Invoices Provider', () => {
    let deployerAccount, deployerKey, senderAccount, senderKey, zkAppAddress, zkAppPrivateKey, zkApp, Tree, testAccounts, vkInvoices;
    beforeAll(async () => {
    ...
    async function mintAccount(privateKey, gasFees = true) {
...
//# sourceMappingURL=InvoicesProvider.test.js.map